...
echo "Download package https://s3.us-west-1.amazonaws.com/fortishield.github.io/packages-dev/warehouse/pullrequests/${MAJOR}.${MINOR}/macos/fortishield-agent-${VERSION}-0.commit${SHA}.pkg"
wget "https://s3.us-west-1.amazonaws.com/fortishield.github.io/packages-dev/warehouse/pullrequests/${MAJOR}.${MINOR}/macos/fortishield-agent-${VERSION}-0.commit${SHA}.pkg" > /dev/null 2>&1
