...
class APILogger(FortishieldLogger):
    ...
    def __init__(self, *args: dict, **kwargs: dict):
        ...
        super().__init__(*args, **kwargs,
                         custom_formatter=FortishieldJsonFormatter if log_path.endswith('json') else None)
    ...
    def setup_logger(self, custom_handler: logging.Handler = None):
        ...
        :param custom_handler: custom handler that can be set instead of the default one from the FortishieldLogger class.
        """
...
class FortishieldJsonFormatter(jsonlogger.JsonFormatter):
    """
