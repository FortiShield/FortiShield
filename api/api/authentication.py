...
def generate_keypair():
    ...
    try:
        ...
        raise FortishieldInternalError(6003)
...
def decode_token(token: str) -> dict:
    ...
    try:
        ...
        payload = jwt.decode(token, generate_keypair()[1], algorithms=[JWT_ALGORITHM], audience='Fortishield API REST')
