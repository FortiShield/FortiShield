...
async def get_status_node(request, node_id: str, pretty: bool = False, wait_for_complete: bool = False) -> web.Response:
    """Get a specified node's Fortishield daemons status.
...
async def get_configuration_node(request, node_id: str, pretty: bool = False, wait_for_complete: bool = False,
    ...
    if isinstance(data, AffectedItemsFortishieldResult):
...
async def get_daemon_stats_node(request, node_id: str, pretty: bool = False, wait_for_complete: bool = False,
    ...
    """Get Fortishield statistical information from the specified daemons of a specified cluster node.
...
async def get_stats_node(request, node_id: str, pretty: bool = False, wait_for_complete: bool = False,
    ...
    Returns Fortishield statistical information in node {node_id} for the current or specified date.
...
async def get_stats_hourly_node(request, node_id: str, pretty: bool = False,
    ...
    Returns Fortishield statistical information in node {node_id} per hour. Each number in the averages field represents the
...
async def get_stats_weekly_node(request, node_id: str, pretty: bool = False,
    ...
    Returns Fortishield statistical information in node {node_id} per week. Each number in the averages field represents the
...
async def get_conf_validation(request, pretty: bool = False, wait_for_complete: bool = False,
                              nodes_list: str = '*') -> web.Response:
    """Check whether the Fortishield configuration in a list of cluster nodes is correct or not.
...
async def update_configuration(request, node_id: str, body: bytes, pretty: bool = False,
                               wait_for_complete: bool = False) -> web.Response:
    """Update Fortishield configuration (ossec.conf) in node node_id.
    ...
    node_id : str
        Node ID.
    body : bytes
        New content for the Fortishield configuration (ossec.conf).
    pretty : bool
        Show results in human-readable format.
    wait_for_complete : bool
        Disable timeout response.
