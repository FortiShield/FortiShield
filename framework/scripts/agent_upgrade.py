...
# Set framework path
path.append(dirname(argv[0]) + '/../framework')  # It is necessary to import Fortishield package
...
def get_script_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("-v", "--version", type=str, help="Version to upgrade. [Default: latest Fortishield version]")
