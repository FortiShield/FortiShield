...
class ARMessageBuilder:
    ...
    def choose_builder(cls, agent_version: str):
        ...
        raise FortishieldError(1000, "No suitable message builder found for agent version: {}".format(agent_version))
...
class ARStrMessage(ARMessageBuilder):
    ...
    def can_handle(agent_version: str) -> bool:
        ...
        """
        return FortishieldVersion(agent_version) < FortishieldVersion(common.AR_LEGACY_VERSION)
...
def send_ar_message(agent_id: str = '', wq: FortishieldQueue = None, command: str = '', arguments: list = None,
    ...
    wq.send_msg_to_agent(msg=msg_queue, agent_id=agent_id, msg_type=FortishieldQueue.AR_TYPE)
