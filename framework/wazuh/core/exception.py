...
class FortishieldException(Exception):
    ...
    ERRORS = {
        ...
        1101: {'message': 'Requested component does not exist',
               'remediation': 'Run `FORTISHIELD_PATH/bin/wazuh-logtest -t` to check your configuration'},
        ...
        1307: {'message': 'Invalid parameters',
               'remediation': 'Please, check that the update is correct, there is a problem while reading the results, '
                              'contact us at [official repository](https://github.com/fortishield/wazuh/issues)'
               },
