...
@patch('wazuh.core.logtest.FortishieldSocketJSON.__init__', return_value=None)
@patch('wazuh.core.logtest.FortishieldSocketJSON.send')
@patch('wazuh.core.logtest.FortishieldSocketJSON.close')
...
def test_send_logtest_msg(create_message_mock, close_mock, send_mock, init_mock, params):
    ...
    """
    with patch('wazuh.core.logtest.FortishieldSocketJSON.receive',
