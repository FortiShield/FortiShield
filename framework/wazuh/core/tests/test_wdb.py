...
def test_async_init():
    ...
    async_wdb = AsyncFortishieldDBConnection('test')
...
async def test_async_open_connection(open_unix_connection_mock):
    ...
    async_wdb = AsyncFortishieldDBConnection(loop='test_loop')
...
def test_async_close():
    ...
    async_wdb = AsyncFortishieldDBConnection()
...
async def test_run_wdb_command():
    """Test `FortishieldDBConnection.run_wdb_command` method."""
