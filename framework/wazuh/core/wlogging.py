...
class TimeBasedFileRotatingHandler(logging.handlers.TimedRotatingFileHandler):
    """
    Fortishield log rotation. It rotates the log at midnight and sets the appropriate permissions to the new log file.
    """
    ...
    def doRollover(self):
        ...
        # Save rotated file in {FORTISHIELD_PATH}/logs/api directory
...
class SizeBasedFileRotatingHandler(logging.handlers.RotatingFileHandler):
    """Fortishield log rotation. It rotates when the logging file size exceeds the maximum number of bytes configured."""
...
class FortishieldLogger:
    ...
    def __init__(self, foreground_mode: bool, log_path: str, debug_level: [int, str], logger_name: str = 'fortishield',
        ...
        log_path : str
            Filepath of the file to send logs to. Relative to the Fortishield installation path.
        ...
        """
        self.log_path = os.path.join(common.FORTISHIELD_PATH, log_path)
        self.logger = None
