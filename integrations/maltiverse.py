...
This integration enrichs any alert generated by Fortishield via the Maltiverse API,
...
And restart Fortishield Manager:
...
#    5 - Invalid URL
#    6 - Unable to connect to Fortishield
#    7 - Unexpected error sending message to Fortishield
...
def process_args(args: list):
    ...
    # Fortishield Manager in case of positive match
...
def send_event(msg: str, agent: dict = None):
    """Send an event to the Fortishield Manager.
    ...
    try:
        ...
        if e.errno == 111:
            print('ERROR: Fortishield is not running.')
            sys.exit(6)
        elif e.errno == 90:
            print('ERROR: Message too long to send to Fortishield.')
            sys.exit(7)
