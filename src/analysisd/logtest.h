...
/* Fortishield-logtest's fields names for the requests and responses */
...
/**
 * @brief Initialize Fortishield Logtest. Initialize the listener and create threads
...
/**
 * @brief Main function of Fortishield Logtest module
 *
