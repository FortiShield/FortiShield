 ...
 * @param sock Fortishield DB socket
 */
...
void w_inc_decoded_by_component_events(const char *component, const char *agent_id) {
    if (component != NULL) {
        ...
        } else if (!strcmp(component, "aws-s3") || !strcmp(component, "Fortishield-AWS")) {
        ...
        } else if (!strcmp(component, "docker-listener") || !strcmp(component, "Fortishield-Docker")) {
            w_inc_modules_docker_decoded_events(agent_id);
        } else if (!strcmp(component, "gcp-pubsub") || !strcmp(component, "gcp-bucket") || !strcmp(component, "Fortishield-GCloud")) {
