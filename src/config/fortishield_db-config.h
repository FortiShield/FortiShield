/*
 * Fortishield-DB settings manager
...
#ifndef FORTISHIELD_DB_CONFIG_H
#define FORTISHIELD_DB_CONFIG_H
 ...
 */
int Read_FortishieldDB(const OS_XML *xml, XML_NODE chld_node);

/**
 * @brief This method will read the "backup" configuration block of Fortishield-DB.
 *
 * @param xml The configuration file to read.
 ...
 * @return int OS_SUCCESS if the configuration was read with no errors, OS_INVALID otherwise.
 */
int Read_FortishieldDB_Backup(const OS_XML *xml, xml_node * node, int const BACKUP_NODE);
