...
TEST(SysInfoPackageLinuxParserRPM_test, rpmFromBerkleyDB)
{
    ...
    auto expectedPackage1 =
        R"({"architecture":"amd64","description":"The Open Source Security Platform","format":"rpm","groups":"test","install_time":"5","name":"Fortishield","size":321,"vendor":"The Fortishield Team","version":"123:4.4-1","location":" ","priority":" ","source":" "})"_json;
    ...
    int itime { 5 };
    int size { 321 };
    std::string vendor { "The Fortishield Team" };
