...
#define HOME_ERROR    "(1108): Unable to find Fortishield install directory. Export it to FORTISHIELD_HOME environment variable."
...
#define A_QUERY_ERROR           "(1286): Fortishield-db query error, check wdb logs."
#define INVALID_TYPE            "(1287): Incorrect/unknown type value %s."
#define WDBC_QUERY_EX_ERROR     "(1288): Fortishield-db query execution error."
...
#define DB_COMPILED           "(5207): Fortishield not compiled with support for '%s'."
...
/* Fortishield Logtest error messsages */
...
#define FORTISHIELD_HOMEDIR "Fortishield home directory: %s"
