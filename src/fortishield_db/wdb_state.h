...
typedef struct _fortishielddb_breakdown_t {
    uint64_t remove_queries;
    struct timeval remove_time;
} fortishielddb_breakdown_t;
...
typedef struct _queries_breakdown_t {
    ...
    uint64_t fortishielddb_queries;
    ...
    fortishielddb_breakdown_t fortishielddb_breakdown;
} queries_breakdown_t;
...
/**
 * @brief Increment total fortishielddb queries counter
 *
 */
void w_inc_fortishielddb();

/**
 * @brief Increment remove fortishielddb queries counter
 *
 */
void w_inc_fortishielddb_remove();

/**
 * @brief Increment remove fortishielddb time counter
 *
...
/**
 * @brief Create a JSON object with all the fortishield-db state information
 * @return JSON object
 */
