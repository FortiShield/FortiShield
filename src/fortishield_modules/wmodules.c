...
int wm_max_eps;             // Maximum events per second sent by OpenScap and CIS-CAT Fortishield Module
...
int wm_config() {
    ...
    wm_task_nice = getDefine_Int("fortishield_modules", "task_nice", -20, 19);
    wm_max_eps = getDefine_Int("fortishield_modules", "max_eps", 1, 1000);
    wm_kill_timeout = getDefine_Int("fortishield_modules", "kill_timeout", 0, 3600);
...
cJSON *getModulesInternalOptions(void) {
    ...
    cJSON_AddNumberToObject(internals,"fortishield_modules.task_nice",wm_task_nice);
    cJSON_AddNumberToObject(internals,"fortishield_modules.max_eps",wm_max_eps);
    cJSON_AddNumberToObject(internals,"fortishield_modules.kill_timeout",wm_kill_timeout);
    cJSON_AddNumberToObject(internals,"fortishield_modules.debug",wm_debug_level);
