...
extern int wm_max_eps;          // Maximum events per second sent by OpenScap Fortishield Module
...
/*
 * @brief Get ID group of Fortishield user.
 *
 * @return ID group.
 */
...
/*
 * @brief Set ID group of fortishield modules
 *
