...
#define SMS_SUBJECT         "Fortishield %d - %d - %s"
#define MAIL_SUBJECT        "Fortishield notification - %s - Alert level %d"
#define MAIL_SUBJECT_FULL   "Fortishield alert - %s - Level %d - %s"
