                            ...
                            agent_info_data *agent_data)
{
    ...
    for (line = strtok_r(msg_tmp, sdelim, &savedptr); line; line = strtok_r(NULL, sdelim, &savedptr)) {
        ...
        case '\"': // Regular label
            ...
            break;
        default:
            // uname - fortishield version / config sum
                ...
                *str_tmp = '\0';
                ...
                if (str_tmp = strstr(line, " / "), str_tmp) {
                    *str_tmp = '\0';
                    ...
                    // If for some reason the separator between Fortishield version and config sum is
                    // not found, we look for the Fortishield version in the second part of the line.
