...
/* Read_FortishieldDB tests */

void test_Read_FortishieldDB_element_NULL(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    ...
    int ret = Read_FortishieldDB(&xml, nodes);
    assert_int_equal(ret, OS_INVALID);

    OS_ClearNode(nodes);
}

void test_Read_FortishieldDB_element_invalid(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_attribute_NULL(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_attribute_invalid(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_attribute_value_invalid(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_content_NULL(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_valid_config(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
/* Read_FortishieldDB_Backup tests */

void test_Read_FortishieldDB_Backup_element_NULL(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
    ...
    int ret = Read_FortishieldDB_Backup(&xml, nodes[0], WDB_GLOBAL_BACKUP);
    assert_int_equal(ret, OS_INVALID);
...
void test_Read_FortishieldDB_Backup_element_invalid(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_Backup_content_NULL(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_Backup_enabled_empty_value(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_Backup_enabled_invalid_value(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_Backup_interval_invalid_value(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_Backup_maxfiles_invalid_string(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_Backup_maxfiles_invalid_value(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_Backup_valid_config(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
void test_Read_FortishieldDB_Backup_valid_config2(void **state)
{
    XML_NODE nodes = NULL;
    OS_XML xml;
    char *test_config =
...
int main(void)
{
    const struct CMUnitTest tests[] = {
        // Tests Read_FortishieldDB
        cmocka_unit_test(test_Read_FortishieldDB_element_NULL),
        cmocka_unit_test(test_Read_FortishieldDB_element_invalid),
        cmocka_unit_test(test_Read_FortishieldDB_attribute_NULL),
        cmocka_unit_test(test_Read_FortishieldDB_attribute_invalid),
        cmocka_unit_test(test_Read_FortishieldDB_attribute_value_invalid),
        cmocka_unit_test(test_Read_FortishieldDB_valid_config),
        // Tests Read_FortishieldDB_Backup
        cmocka_unit_test(test_Read_FortishieldDB_Backup_element_NULL),
        cmocka_unit_test(test_Read_FortishieldDB_Backup_element_invalid),
        cmocka_unit_test(test_Read_FortishieldDB_Backup_content_NULL),
        cmocka_unit_test(test_Read_FortishieldDB_Backup_enabled_empty_value),
        cmocka_unit_test(test_Read_FortishieldDB_Backup_enabled_invalid_value),
        cmocka_unit_test(test_Read_FortishieldDB_Backup_interval_invalid_value),
        cmocka_unit_test(test_Read_FortishieldDB_Backup_maxfiles_invalid_string),
        cmocka_unit_test(test_Read_FortishieldDB_Backup_maxfiles_invalid_value),
        cmocka_unit_test(test_Read_FortishieldDB_Backup_valid_config),
