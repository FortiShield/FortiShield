...
#include "../../wrappers/fortishield/fortishield_modules/wm_task_manager_wrappers.h"

#include "../../fortishield_modules/wmodules.h"
#include "../../fortishield_modules/task_manager/wm_task_manager.h"
#include "../../fortishield_modules/task_manager/wm_task_manager_tasks.h"
...
void test_wm_task_manager_destroy(void **state)
{
    ...
    expect_string(__wrap__mtinfo, tag, "fortishield-modulesd:task-manager");
...
void test_wm_task_manager_init_bind_err(void **state)
{
    ...
    expect_string(__wrap__mterror, tag, "fortishield-modulesd:task-manager");
...
void test_wm_task_manager_dispatch_ok(void **state)
{
    ...
    expect_string(__wrap__mtdebug1, tag, "fortishield-modulesd:task-manager");
