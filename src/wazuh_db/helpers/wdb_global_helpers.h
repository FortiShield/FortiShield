/*
 * Fortishield DB helper module for agents database
 ...
 * @param[in] sock The Fortishield DB socket connection. If NULL, a new connection will be created and closed locally.
 ...
 * This method creates and sends a command to FortishieldDB to receive the ID of every agent.
 ...
 * This method creates and sends a command to FortishieldDB to set as disconnected all the
