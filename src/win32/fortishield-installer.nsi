...
!define REVISION "50000"
!define NAME "Fortishield"
!define SERVICE "FortishieldSvc"
...
BrandingText "Copyright (C) 2015, Fortishield Inc."
OutFile "${OutFile}"

VIProductVersion "5.0.0.0"
VIAddVersionKey ProductName "${NAME}"
VIAddVersionKey CompanyName "Fortishield Inc."
VIAddVersionKey LegalCopyright "2023 - Fortishield Inc."
VIAddVersionKey FileDescription "Fortishield Agent installer"
VIAddVersionKey FileVersion "${VERSION}"
VIAddVersionKey ProductVersion "${VERSION}"
VIAddVersionKey InternalName "Fortishield Agent"
...
Section "Fortishield Agent (required)" MainSec
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\OSSEC" "HelpLink" "https://fortishield.github.io"
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\OSSEC" "URLInfoAbout" "https://fortishield.github.io"
