...
brief: The 'fortishield-analysisd' daemon receives the log messages and compares them to the rules.
       ...
       alerts from Linux 'syscheck' events considered rare.
...
from fortishield_testing.modules.analysisd import patterns, utils, configuration as analysisd_config
...
monitored_sockets_params = [(FORTISHIELD_DB_DAEMON, None, None), (ANALYSISD_DAEMON, mitm_analysisd, True)]
...
def test_validate_all_rare_alerts(test_metadata, configure_local_internal_options, truncate_monitored_files_module,
    ...
    '''
    description: Check if the alerts generated by the 'fortishield-analysisd' daemon from Linux 'syscheck' events
    ...
    inputs:
        - 12298 test cases distributed among 'syscheck' events of type 'added', 'modified', and 'deleted'.
