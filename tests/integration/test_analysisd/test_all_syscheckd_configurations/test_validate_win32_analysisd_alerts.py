...
test_cases_path = Path(TEST_CASES_PATH, 'cases_syscheck_events_win32.yaml')
...
def test_validate_all_win32_alerts(test_metadata, configure_local_internal_options, truncate_monitored_files_module,
    ...
    '''
    description: Check if the alerts generated by the 'fortishield-analysisd' daemon from
