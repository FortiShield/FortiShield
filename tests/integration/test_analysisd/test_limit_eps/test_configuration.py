...
def test_accepted_values(test_configuration, test_metadata, load_fortishield_basic_configuration, set_fortishield_configuration,
    ...
    """
    # Start monitor
    monitor_enabled = file_monitor.FileMonitor(FORTISHIELD_LOG_PATH)
...
def test_invalid_values(test_configuration, test_metadata, load_fortishield_basic_configuration, set_fortishield_configuration,
                        truncate_monitored_files, daemons_handler):
    """
    ...
    """
    # Start monitor
    monitor_error = file_monitor.FileMonitor(FORTISHIELD_LOG_PATH)
...
def test_missing_configuration(test_configuration, test_metadata, load_fortishield_basic_configuration, set_fortishield_configuration,
    ...
    """
    log_monitor = file_monitor.FileMonitor(FORTISHIELD_LOG_PATH)
