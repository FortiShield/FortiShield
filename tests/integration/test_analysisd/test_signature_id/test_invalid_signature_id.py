...
from fortishield_testing.modules.analysisd.testrule import patterns
...
def test_invalid_signature_id(test_configuration, test_metadata, set_fortishield_configuration, truncate_monitored_files,
    ...
    assertions:
        - Check that fortishield starts
        - Check ".*fortishield-testrule.*Empty 'if_sid' value. Rule '(\\d*)' will be ignored.*"
    ...
    '''
    # Start monitor
    monitor_invalid = file_monitor.FileMonitor(FORTISHIELD_LOG_PATH)
