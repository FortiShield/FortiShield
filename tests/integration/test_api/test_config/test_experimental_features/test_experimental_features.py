...
from fortishield_testing.constants.api import CONFIGURATION_TYPES, SYSCOLLECTOR_OS_ROUTE
...
# Paths
test_configuration_path = Path(CONFIGURATIONS_FOLDER_PATH, 'configuration_experimental_features.yaml')
test_cases_path = Path(TEST_CASES_FOLDER_PATH, 'cases_experimental_features.yaml')
