...
references:
    ...
    - https://documentation.fortishield.com/current/user-manual/api/configuration.html#api-configuration-options
...
def test_host_port(test_configuration, test_metadata, add_configuration, truncate_monitored_files, daemons_handler,
    ...
    test_phases:
        ...
        - test:
            - Check that expected host and port appear in the Fortishield API log
