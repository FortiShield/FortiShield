...
# Variables
log_monitor_paths = []
receiver_sockets_params = [(AUTHD_SOCKET_PATH, 'AF_UNIX', 'TCP'), (FORTISHIELD_DB_SOCKET_PATH, 'AF_UNIX', 'TCP')]

daemons_handler_configuration = {'all_daemons': True}

# TODO Replace or delete
monitored_sockets_params = [(FORTISHIELD_DB_DAEMON, None, True), (AUTHD_DAEMON, None, True)]
