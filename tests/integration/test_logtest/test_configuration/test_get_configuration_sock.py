...
import pytest
from fortishield_testing.constants.paths.sockets import ANALYSISD_ANALISIS_SOCKET_PATH
...
def test_get_configuration_sock(test_configuration, test_metadata, set_fortishield_configuration,
