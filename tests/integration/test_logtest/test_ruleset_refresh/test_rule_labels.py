...
for i in range(1,5):
    t_aux_config_path = Path(CONFIGURATIONS_FOLDER_PATH, 'configuration_rule_labels_' + str(i) + '.yaml')
    t_aux_cases_path = Path(TEST_CASES_FOLDER_PATH, 'cases_rule_labels_' + str(i) + '.yaml')
...
def test_rule_list(test_configuration, test_metadata, set_fortishield_configuration,
