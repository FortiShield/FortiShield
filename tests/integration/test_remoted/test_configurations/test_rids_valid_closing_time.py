...
cases_path = Path(TEST_CASES_PATH, 'cases_rids_valid_closing_time.yaml')
config_path = Path(CONFIGS_PATH, 'config_rids_closing_time.yaml')
...
def test_rids_closing_time_valid(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
