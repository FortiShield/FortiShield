...
from fortishield_testing.tools.simulators.agent_simulator import send_ping_pong_messages
...
def test_ping_pong_message(test_configuration, test_metadata, configure_local_internal_options, truncate_monitored_files,
                            set_fortishield_configuration, restart_fortishield_expect_error, protocols_list_to_str_upper_case):
