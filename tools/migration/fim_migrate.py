...
# Copyright (C) 2015, Fortishield Inc. <info@wazuh.com>
# September 28, 2018.
...
def _print_help():
    print('''
    FIM database upgrade tool for Fortishield
...
if __name__ == '__main__':
    ...
    if _verbose:
        logging.debug("Connected to FortishieldDB socket ({0})".format(_wdb_socket))
