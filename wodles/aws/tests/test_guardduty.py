...
def test_aws_guardduty_bucket_check_guardduty_type(mock_fortishield_aws_integration, mock_sts,
...
@patch('fortishield_integration.FortishieldIntegration.get_sts_client')
@patch('fortishield_integration.FortishieldAWSDatabase.__init__')
def test_aws_guardduty_bucket_check_guardduty_type_handles_exceptions(mock_fortishield_aws_integration, mock_sts):
...
@patch('fortishield_integration.FortishieldIntegration.get_sts_client')
@patch('fortishield_integration.FortishieldAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_full_prefix(mock_fortishield_aws_integration, mock_sts, mock_service_prefix,
                                              guardduty_native):
...
@patch('fortishield_integration.FortishieldIntegration.get_sts_client')
@patch('fortishield_integration.FortishieldAWSDatabase.__init__')
def test_aws_guardduty_bucket_get_base_prefix(mock_fortishield_aws_integration, mock_sts, guardduty_native: bool):
...
@patch('fortishield_integration.FortishieldIntegration.get_sts_client')
@patch('fortishield_integration.FortishieldAWSDatabase.__init__')
def test_aws_guardduty_bucket_iter_regions_and_accounts(mock_fortishield_aws_integration, mock_sts, guardduty_native: bool):
