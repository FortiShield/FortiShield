...
def test_aws_sqs_queue_initializes_properly(mock_fortishield_integration, mock_get_sqs_url, mock_message_processor,
...
def test_aws_sqs_queue_delete_message(mock_fortishield_integration, mock_sts_client, mock_get_url):
...
@patch('fortishield_integration.FortishieldIntegration.get_sts_client')
@patch('fortishield_integration.FortishieldIntegration.__init__', side_effect=fortishield_integration.FortishieldIntegration.__init__)
def test_aws_sqs_queue_delete_message_handles_exception_when_deleting_message(mock_fortishield_integration, mock_sts_client):
...
@patch('fortishield_integration.FortishieldIntegration.get_sts_client')
@patch('fortishield_integration.FortishieldIntegration.__init__', side_effect=fortishield_integration.FortishieldIntegration.__init__)
def test_aws_sqs_queue_fetch_messages(mock_fortishield_integration, mock_sts_client, mock_get_url):
...
@patch('fortishield_integration.FortishieldIntegration.get_sts_client')
@patch('fortishield_integration.FortishieldIntegration.__init__', side_effect=fortishield_integration.FortishieldIntegration.__init__)
def test_aws_sqs_queue_fetch_messages_handles_exception_when_getting_messages(mock_fortishield_integration, mock_sts_client):
...
@patch('fortishield_integration.FortishieldIntegration.get_sts_client')
@patch('fortishield_integration.FortishieldIntegration.__init__', side_effect=fortishield_integration.FortishieldIntegration.__init__)
def test_aws_sqs_queue_get_messages(mock_fortishield_integration, mock_sts_client, mock_fetch):
...
@patch('fortishield_integration.FortishieldIntegration.get_sts_client')
@patch('fortishield_integration.FortishieldIntegration.__init__', side_effect=fortishield_integration.FortishieldIntegration.__init__)
def test_aws_sqs_queue_sync_events(mock_fortishield_integration, mock_sts_client):
