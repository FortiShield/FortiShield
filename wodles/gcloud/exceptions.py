...
class FortishieldIntegrationException(Exception):
    """Class that represents an exception for the Fortishield external integrations.
...
class FortishieldIntegrationInternalError(FortishieldIntegrationException):
    """Class that represents a critical exception for the Fortishield external integrations."""
    ERRORS = {
        # 1-99 -> Internal errors
        1: {
            'key': 'GCloudFortishieldNotRunning',
            'message': 'Fortishield must be running'
        },
        2: {
        ...
        3: {
            ...
            'message': 'Error sending event to Fortishield'
        },
    }

class GCloudError(FortishieldIntegrationException):
