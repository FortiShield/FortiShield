...
class FortishieldGCloudIntegration:
    """Class for sending events from Google Cloud to Fortishield."""

    header = '1:Fortishield-GCloud:'
    key_name = 'gcp'

    def __init__(self, logger: logging.Logger):
        """Instantiate a FortishieldGCloudIntegration object.
    ...
    def initialize_socket(self):
        ...
        Raises
        ------
        exceptions.FortishieldIntegrationInternalError
        ...
        try:
            ...
            raise exceptions.FortishieldIntegrationInternalError(1)
        except OSError:
            raise exceptions.FortishieldIntegrationInternalError(2, socket_path=ANALYSISD)

    def process_data(self):
        raise NotImplementedError

    def send_msg(self, msg: str):
        """Send an event to the Fortishield queue.
        ...
        try:
            ...
            raise exceptions.FortishieldIntegrationInternalError(3)
