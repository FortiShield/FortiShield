...
import exceptions
from integration import FortishieldGCloudIntegration
...
class FortishieldGCloudSubscriber(FortishieldGCloudIntegration):
    ...
    def __init__(self, credentials_file: str, project: str, logger: logging.Logger, subscription_id: str):
        """Instantiate a FortishieldGCloudSubscriber object.
