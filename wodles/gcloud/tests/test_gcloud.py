...
@patch('gcloud.FortishieldGCloudSubscriber')
...
@patch('pubsub.subscriber.FortishieldGCloudSubscriber.check_permissions')
@patch('pubsub.subscriber.FortishieldGCloudSubscriber.process_messages')
